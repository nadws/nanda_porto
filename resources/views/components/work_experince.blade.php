<div class="grid grid-cols-4 mt-5">
    ...
    <div class="md:col-span-2 md:mt-10 xs:mt-5 xs:col-span-4  flex items-center">
        <div class="md:ml-4 xs:ml-2 flex flex-col">
            <p class="whitespace-nowrap font-roboto text-black dark:text-white font-medium text-base">Work Experince</p>
    ...
    <div class="md:col-span-2 md:mt-5 xs:mt-2 xs:col-span-4 flex flex-col space-y-2">
        <div class="grid grid-cols-3">
            <div class="col-span-1">
                <p class="font-roboto md:ml-4 xs:ml-2 text-black dark:text-white font-thin md:text-lg xs:text-sm">2020
                    - present
                </p>
            </div>
